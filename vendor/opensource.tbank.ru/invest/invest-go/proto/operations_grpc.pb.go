...
type OperationsStreamServiceClient interface {
	...
	OperationsStream(ctx context.Context, in *OperationsStreamRequest, opts ...grpc.CallOption) (OperationsStreamService_OperationsStreamClient, error)
}
...
func (c *operationsStreamServiceClient) OperationsStream(ctx context.Context, in *OperationsStreamRequest, opts ...grpc.CallOption) (OperationsStreamService_OperationsStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &OperationsStreamService_ServiceDesc.Streams[2], OperationsStreamService_OperationsStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &operationsStreamServiceOperationsStreamClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type OperationsStreamService_OperationsStreamClient interface {
	Recv() (*OperationsStreamResponse, error)
	grpc.ClientStream
}

type operationsStreamServiceOperationsStreamClient struct {
	grpc.ClientStream
}

func (x *operationsStreamServiceOperationsStreamClient) Recv() (*OperationsStreamResponse, error) {
	m := new(OperationsStreamResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type OperationsStreamServiceServer interface {
	...
	// OperationsStream — стрим обновлений операций
	OperationsStream(*OperationsStreamRequest, OperationsStreamService_OperationsStreamServer) error
...
func (UnimplementedOperationsStreamServiceServer) OperationsStream(*OperationsStreamRequest, OperationsStreamService_OperationsStreamServer) error {
...
func _OperationsStreamService_OperationsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(OperationsStreamServiceServer).OperationsStream(m, &operationsStreamServiceOperationsStreamServer{stream})
}

type OperationsStreamService_OperationsStreamServer interface {
	Send(*OperationsStreamResponse) error
	grpc.ServerStream
}

type operationsStreamServiceOperationsStreamServer struct {
	grpc.ServerStream
}

func (x *operationsStreamServiceOperationsStreamServer) Send(m *OperationsStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}
